...
namespace Banco
{
    public partial class Form1 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Conta selecionada = (Conta)comboTransferencia.SelectedItem;
            TextoTransfTitular.Text = selecionadaDestino.Titular.Nome;
            TextoTransfNumero.Text = Convert.ToString(selecionada.Numero);
        }
        ...
        public void Remove(Conta conta)
        {
            ...
            comboTransferencia.Items.Remove(conta);
        }
